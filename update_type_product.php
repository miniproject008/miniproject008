<?php 
    ...
    $id = $_GET['c_no'];
    $sql = "select * from tbl_type_product where c_no='$id'";
...
<body class="colerA">
    <div class="container sm-1">
        <h1 class="mt-3"style="color:MediumSeaGreen ;text-align: center;">แก้ไขชนิด ข้อมูลสินค้า</h1>
        <hr>
        <form class="pand" action="upd_save_type_product.php?c_no=<?=$_GET["c_no"];?>" enctype="multipart/form-data"   method="POST">
            
            
            <div  style ="background-color: #696969; padding-bottom: 50px; padding-top: 50px;">
                <div class="text-center">
                    <label for="fname"  style="color:MediumSeaGreen;">รหัสประเภทสินค้า</label>
                    <br>
                ...
                <br>
                <div class="text-center" >
                    <label   style="color:MediumSeaGreen;">ชื่อประเภท</label>
                    <br>
